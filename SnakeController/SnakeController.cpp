...
{
    std::uint32_t event_id = e->getMessageId();
    switch(event_id)
    {
        case 0x20:
            handleTimePassed((const TimeoutInd&)*e);
            break;
        case 0x10:
            handleDirectionChange((const DirectionInd&)*e);
            break;
        case 0x40:
            handleFoodPositionChange((const FoodInd&)*e);
            break;
        case 0x42:
            handleNewFood((const FoodResp&)*e);
            break;
        default:
